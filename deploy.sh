...
#comando gerando executavel LInux Openvino 2019 R.1.1
pyinstaller portao_virtual_tracking.py --onefile -y -p /home/igor/.local/lib/python3.6/site-packages/matplotlib:. -p openvino:. --add-data regions.json:. --add-data config.json:. --add-data campainha.mp3:. --add-data dlModels:. --distpath ../deploy --add-binary /home/igor/intel/openvino_2019.1.144/deployment_tools/inference_engine/lib/intel64:. --add-data /home/igor/intel/openvino_2019.1.144/deployment_tools/inference_engine/lib/intel64:. -p /home/igor/intel/openvino_2019.1.144/opencv:. --add-binary /home/igor/intel/openvino_2019.1.144/opencv/lib/:. --hidden-import opencv
